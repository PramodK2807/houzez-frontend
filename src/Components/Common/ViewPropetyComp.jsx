          ...
          <div className="card_content bg-light">
            ...
            <div>
              <div className="border-bottom">
                <p className="card_title p-0 m-0">Renovated Luxury Apartment</p>
          ...
          <div className="description">
            <div className="border mt_12 box_shadow">
              ...
              <p className="p-3 mb-0">
                ...
                distinctio quaerat quo eaque animi placeat eos aut soluta nihil
                autem tenetur, aperiam quia minima itaque voluptas tempora
                aliquid consectetur temporibus iure ab earum. Eaque, quidem.
              </p>
            </div>
            <div className="border mt_12 box_shadow">
              <p className="user_title_heading_div">
...
export default ViewPropetyComp;
